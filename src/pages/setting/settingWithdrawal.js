...
import {View, StyleSheet, SafeAreaView, Text, Pressable, Image, Alert} from 'react-native';
  ...
  return (
    <SafeAreaView style={[GlobalStyle.safeAreaWrap, styles.mainWrap]}>
      ...
      <View style={GlobalStyle.header}>
        ...
        <Text style={[GlobalStyle.font_caption1]}>Withdrawal</Text>
      ...
      <View style={styles.body}>
        ...
        />
        <Text style={[GlobalStyle.font_title2, GlobalStyle.fontRED]}>탈퇴하시면,</Text>
        <Text style={[GlobalStyle.font_body, GlobalStyle.fontRED]}>- 프리미엄 구독 내역이 모두 사라져요!</Text>
        <Text style={[GlobalStyle.font_body, GlobalStyle.fontRED]}>- 작성했던 일기와 사진들이 모두 사라져요!</Text>
      </View>

      <View style={styles.footer}>
        <Text style={[GlobalStyle.fontBLUE, GlobalStyle.font_body]}>소곤소곤을 떠나실건가요?</Text>
        <Pressable
